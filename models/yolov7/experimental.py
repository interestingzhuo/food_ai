...
from models.yolov7.common import Conv, DWConv
from models.yolov7.google_utils import attempt_download
...
class ONNX_ORT(nn.Module):
    ...
    def forward(self, x):
        ...
        selected_indices = ORT_NMS.apply(nmsbox, max_score_tp, self.max_obj,
                                         self.iou_threshold,
        ...
        return torch.cat(
            [X, selected_boxes, selected_categories, selected_scores], 1)
